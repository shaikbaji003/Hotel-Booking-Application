        ...
        <div className="row mb-5">
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={require('../images/baji.jpeg.jpeg')} className="card-img-top" alt="director" />
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={require('../images/team2.jpeg.jpeg')} className="card-img-top" alt="director" />
                    <div className="card-body">
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={require('../images/team3.jpeg.jpeg')} className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">Team Member</h5>
